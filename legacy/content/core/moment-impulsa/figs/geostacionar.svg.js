...
<svg viewBox="0 0 500 480" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Планета с двумя круговыми орбитами: низкой у поверхности и далёкой геостационарной радиуса R">
  ...
  <!-- низкая орбита -->
  <circle cx="235" cy="245" r="78" fill="none" stroke="var(--fig-a, #0f7a8a)" stroke-width="2.2" stroke-dasharray="10 7"/>
  <circle cx="157" cy="245" r="5.5" fill="var(--fig-a, #0f7a8a)"/>
  <path d="M 325.2 212.2 A 96 96 0 0 0 235 149" fill="none" stroke="var(--fig-a, #0f7a8a)" stroke-width="2.6"/>
  <polygon points="225,149 235,143.5 235,154.5" fill="var(--fig-a, #0f7a8a)"/>
  <!-- радиусы -->
  ...
  <g font-family="Georgia, 'Times New Roman', serif" font-size="18">
    ...
    <text x="148" y="228" text-anchor="middle" fill="var(--fig-a, #0f7a8a)">Низкая</text>
  </g>
</svg>`;
