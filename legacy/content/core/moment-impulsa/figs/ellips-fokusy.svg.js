...
<svg viewBox="0 0 520 344" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Эллипс с фокусами F1 и F2, большой осью 2a, малой осью 2b и точкой M, соединённой с фокусами отрезками r1 и r2">
  ...
  <!-- большая ось 2a -->
  <line x1="28" y1="170" x2="492" y2="170" stroke="var(--fig-a, #0f7a8a)" stroke-width="2.4"/>
  <polygon points="20,170 32,164.5 32,175.5" fill="var(--fig-a, #0f7a8a)"/>
  <polygon points="500,170 488,164.5 488,175.5" fill="var(--fig-a, #0f7a8a)"/>
  <!-- малая ось 2b -->
  ...
  <g font-family="Georgia, 'Times New Roman', serif" font-style="italic" font-size="21">
    ...
    <text x="216" y="160" text-anchor="end" fill="var(--fig-a, #0f7a8a)">2a</text>
