...
<svg viewBox="0 0 760 320" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Три панели: молекула с реальным радиусом заметает полосу среди мишеней; точечная молекула среди раздутых мишеней; раздутая молекула среди точечных мишеней">
  ...
  <circle cx="185" cy="187" r="20" fill="var(--fig-a, #0f7a8a)"/>
  <!-- мишень вне полосы -->
  <circle cx="205" cy="72" r="20" fill="var(--fig-a, #0f7a8a)" opacity="0.45"/>
  <g font-family="Georgia, 'Times New Roman', serif" font-style="italic" font-size="19">
    <text x="44" y="118" fill="var(--fig-b, #c2571a)">r&#8321;</text>
    <text x="212" y="210" fill="var(--fig-a, #0f7a8a)">r&#8322;</text>
  </g>
  ...
  <circle cx="425" cy="187" r="46" fill="var(--fig-a, #0f7a8a)" opacity="0.18"/>
  <circle cx="425" cy="187" r="46" fill="none" stroke="var(--fig-a, #0f7a8a)" stroke-width="2" stroke-dasharray="6 5"/>
  <circle cx="425" cy="187" r="3.5" fill="var(--fig-a, #0f7a8a)"/>
  <line x1="425" y1="187" x2="459" y2="156" stroke="var(--fig-a, #0f7a8a)" stroke-width="1.6"/>
  <!-- раздутая мишень вне траектории -->
  <circle cx="462" cy="70" r="46" fill="none" stroke="var(--fig-a, #0f7a8a)" stroke-width="1.6" stroke-dasharray="6 5" opacity="0.5"/>
  <circle cx="462" cy="70" r="3.5" fill="var(--fig-a, #0f7a8a)" opacity="0.5"/>
  <g font-family="Georgia, 'Times New Roman', serif" font-style="italic" font-size="18">
    <text x="452" y="146" fill="var(--fig-a, #0f7a8a)">r&#8321;+r&#8322;</text>
  </g>
  ...
  <circle cx="672" cy="176" r="4.5" fill="var(--fig-a, #0f7a8a)"/>
  <circle cx="700" cy="66" r="4.5" fill="var(--fig-a, #0f7a8a)" opacity="0.5"/>
  <g font-family="Georgia, 'Times New Roman', serif" font-style="italic" font-size="18">
