...
<svg viewBox="0 0 520 300" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Ящик между координатами x и x плюс dx; слева входит поток j от x, справа выходит поток j от x плюс dx, левая грань площади S выделена">
  ...
  <polygon points="210,90 244,66 244,186 210,210" fill="var(--fig-a, #0f7a8a)" opacity="0.25"/>
  <!-- корпус ящика -->
  ...
  <text x="222" y="146" font-family="Georgia, 'Times New Roman', serif" font-style="italic" font-size="20" fill="var(--fig-a, #0f7a8a)">S</text>
