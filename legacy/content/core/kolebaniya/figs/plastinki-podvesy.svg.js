...
<svg viewBox="0 0 480 300" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Квадратная пластинка на нитях двумя способами: слева нити сходятся в одну точку, справа нити параллельны; расстояние от подвеса до верхней стороны равно стороне квадрата">
  ...
  <line x1="130" y1="40" x2="130" y2="130" stroke="var(--fig-a, #0f7a8a)" stroke-width="1.5" stroke-dasharray="5 5"/>
  <text x="120" y="92" text-anchor="end" font-family="Georgia, 'Times New Roman', serif" font-style="italic" font-size="17" fill="var(--fig-a, #0f7a8a)">a</text>
  ...
  <text x="280" y="92" text-anchor="end" font-family="Georgia, 'Times New Roman', serif" font-style="italic" font-size="17" fill="var(--fig-a, #0f7a8a)">a</text>
  <!-- сторона квадрата -->
  <g stroke="var(--fig-a, #0f7a8a)" stroke-width="1.6">
    <line x1="290" y1="262" x2="400" y2="262"/>
    <line x1="290" y1="256" x2="290" y2="268"/>
    <line x1="400" y1="256" x2="400" y2="268"/>
  </g>
  <text x="345" y="286" text-anchor="middle" font-family="Georgia, 'Times New Roman', serif" font-style="italic" font-size="17" fill="var(--fig-a, #0f7a8a)">a</text>
</svg>`;
