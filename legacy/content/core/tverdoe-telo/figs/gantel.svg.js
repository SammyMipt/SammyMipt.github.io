...
<svg viewBox="0 0 268 378" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Гантель из двух масс вращается вокруг оси z под углом к ней; вектор момента импульса наклонён к оси, описывает конус, его проекция на ось постоянна">
  ...
  <ellipse cx="122" cy="155" rx="60" ry="15" fill="none" stroke="var(--fig-a, #0f7a8a)" stroke-width="1.4" stroke-dasharray="5 4" opacity="0.75"/>
  <!-- вектор момента импульса L -->
  <line x1="122" y1="290" x2="178" y2="164" stroke="var(--fig-a, #0f7a8a)" stroke-width="3"/>
  <polygon points="182,155 181.6,166.9 173.4,163.2" fill="var(--fig-a, #0f7a8a)"/>
  <!-- проекция L_z (пунктир вдоль оси) -->
  <line x1="122" y1="290" x2="122" y2="166" stroke="var(--fig-a, #0f7a8a)" stroke-width="2" stroke-dasharray="6 4"/>
  <polygon points="122,155 126.5,166 117.5,166" fill="var(--fig-a, #0f7a8a)"/>
  <!-- подписи -->
  <g font-family="Georgia, 'Times New Roman', serif" font-style="italic" font-size="19">
    ...
    <text x="188" y="152" fill="var(--fig-a, #0f7a8a)">L</text>
    <text x="114" y="162" text-anchor="end" fill="var(--fig-a, #0f7a8a)">L<tspan dy="5" font-size="14">z</tspan></text>
