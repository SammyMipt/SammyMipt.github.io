...
<svg viewBox="0 0 600 190" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Три катушки на поверхности: нить тянут под разными углами; направление вращения зависит от того, по какую сторону от точки касания проходит линия действия силы">
  ...
  <path d="M 27.6 96.1 A 74.4 74.4 0 0 1 89.1 28.8" fill="none" stroke="var(--fig-a, #0f7a8a)" stroke-width="2.2"/>
  <polygon points="89.1,28.8 79.1,35.3 77.5,26.5" fill="var(--fig-a, #0f7a8a)"/>
  ...
  <path d="M 399.6 96.1 A 74.4 74.4 0 0 1 461.1 28.8" fill="none" stroke="var(--fig-a, #0f7a8a)" stroke-width="2.2"/>
  <polygon points="399.6,96.1 395.1,85.1 404.1,85.1" fill="var(--fig-a, #0f7a8a)"/>
  <!-- подписи -->
  <g font-family="Georgia, 'Times New Roman', serif" font-style="italic" font-size="18">
    ...
    <text x="14" y="103" fill="var(--fig-a, #0f7a8a)">&#969;</text>
    <text x="288" y="22" text-anchor="middle" fill="var(--fig-a, #0f7a8a)">&#969; = 0</text>
    <text x="391" y="119" text-anchor="end" fill="var(--fig-a, #0f7a8a)">&#969;</text>
  </g>
</svg>
`;
