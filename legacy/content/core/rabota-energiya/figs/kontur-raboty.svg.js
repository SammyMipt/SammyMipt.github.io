...
<svg viewBox="0 0 420 220" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Две дуги между точками 1 и 2: верхний путь I и нижний путь II">
  <path d="M 60 110 Q 210 20 360 110" fill="none" stroke="var(--fig-a, #0f7a8a)" stroke-width="3"/>
  <polygon points="360,110 352.1,109.0 355.4,103.4" fill="var(--fig-a, #0f7a8a)"/>
  ...
  <g font-family="Georgia, 'Times New Roman', serif" font-size="22">
    ...
    <text x="210" y="50" text-anchor="middle" fill="var(--fig-a, #0f7a8a)">I</text>
