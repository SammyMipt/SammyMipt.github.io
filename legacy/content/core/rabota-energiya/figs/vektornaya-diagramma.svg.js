...
<svg viewBox="0 0 520 300" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Векторная диаграмма: скорость центра масс, окружность возможных скоростей в системе центра масс и предельный угол отклонения при касании">
  ...
  <line x1="340" y1="130" x2="396" y2="34.2" stroke="var(--fig-a, #0f7a8a)" stroke-width="2.8"/>
  <polygon points="400,27.4 389.2,32.4 397.1,39.1" fill="var(--fig-a, #0f7a8a)"/>
  <line x1="40" y1="130" x2="393" y2="29.4" stroke="var(--fig-a, #0f7a8a)" stroke-width="2.8"/>
  <polygon points="400,27.4 388.9,31.9 396.4,39.4" fill="var(--fig-a, #0f7a8a)"/>
  ...
  <g font-family="Georgia, 'Times New Roman', serif" font-style="italic" font-size="20">
    ...
    <text x="380" y="84" fill="var(--fig-a, #0f7a8a)">v<tspan dy="5" font-size="14">1c</tspan><tspan dy="-5" font-size="20">&#8242;</tspan></text>
    <text x="200" y="62" text-anchor="middle" fill="var(--fig-a, #0f7a8a)">v<tspan dy="5" font-size="14">1</tspan><tspan dy="-5" font-size="20">&#8242;</tspan></text>
