...
<svg viewBox="0 0 640 360" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Две машины Карно: прямая сверху совершает работу A, обратная снизу на эту работу возвращает тепло от холодильника нагревателю">
  ...
  <rect x="470" y="40" width="150" height="76" rx="4" fill="var(--fig-a, #0f7a8a)" fill-opacity=".14" stroke="var(--fig-a, #0f7a8a)" stroke-width="2.4"/>
  ...
  <rect x="470" y="250" width="150" height="76" rx="4" fill="var(--fig-a, #0f7a8a)" fill-opacity=".14" stroke="var(--fig-a, #0f7a8a)" stroke-width="2.4"/>
