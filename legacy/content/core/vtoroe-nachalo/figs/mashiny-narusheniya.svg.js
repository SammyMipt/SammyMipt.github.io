...
<svg viewBox="0 0 680 220" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Слева машина Клаузиуса: перечёркнутая стрелка тепла от холодного резервуара к горячему. Справа машина Томпсона: тепло Q одного резервуара целиком уходит в работу A">
  ...
  <rect x="16" y="70" width="118" height="70" rx="4" fill="var(--fig-a, #0f7a8a)" fill-opacity=".14" stroke="var(--fig-a, #0f7a8a)" stroke-width="2.4"/>
  ...
  <rect x="420" y="70" width="100" height="70" rx="4" fill="var(--fig-a, #0f7a8a)" fill-opacity=".14" stroke="var(--fig-a, #0f7a8a)" stroke-width="2.4"/>
